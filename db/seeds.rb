...
dino4 = Dinosaur.create!( { name: "Aristratus", age: rand(1..100), image_url: "https://goo.gl/EqRlgP"})
dino5 = Dinosaur.create!( { name: "Valeptrosaurus", age: rand(1..100), image_url: "https://goo.gl/EqRlgP"})
